...
class Bot(discord.Client):
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='with Just for fun | ¥'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjM0Nzg4MzM0MzcxMjA5MjU3.XanmwQ.uwhC7rmCepYVUrsDdAb2ic3BN-M'))
    loop.run_forever()
